...
repositories {
    mavenLocal()
    // Prefer Maven Central; avoid duplicate explicit central URLs
    mavenCentral()

    // JetBrains Space mirror: restrict its scope to kotlinx-html group only
    maven {
    ...
    // Add Google and Gradle Plugin Portal to cover common plugin artifacts
    google()
    gradlePluginPortal()
}
