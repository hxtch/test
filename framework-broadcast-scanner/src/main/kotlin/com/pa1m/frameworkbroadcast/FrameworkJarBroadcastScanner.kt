...
open class FrameworkJarBroadcastScanner(
    ...
    private val scanAllReceivers: Boolean = true,
    ...
    fun scan(jarDir: Path, protectedBroadcasts: Set<String>, permissions: Map<String, PermissionMeta>): ScanResult {
        ...
        progressReporter.onScanStarted(jars.size)
        for ((index, jar) in jars.withIndex()) {
            val jarResult = scanSingleJar(jar.toAbsolutePath(), allJars, protectedBroadcasts, permissions)
